...
\begin{aligned}
    & \begin{aligned}
        ...
        & \qquad \qquad \color{grey} \texttt{const} & & \color{grey} \texttt{goto} & & \texttt{sizeof} & & \color{grey} \texttt{\_} \texttt{Bool} \\
        & \qquad \qquad \texttt{continue} & & \texttt{if} & & \color{grey} \texttt{static} & & \color{grey} \texttt{\_} {Complex} \\
        & \qquad \qquad \texttt{default} & & \color{grey} \texttt{inline} & & \color{grey} \texttt{struct} & & \color{grey} \texttt{\_} {Imaginary} \\
